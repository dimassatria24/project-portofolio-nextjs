...
function DialogBody({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'bg-neutral-25 md: z-10 mx-auto h-68 w-90 rounded-2xl px-6 pt-20 md:h-72 md:w-120 md:px-8',
        className
      )}
      {...props}
    />
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        'text-lg-semibold md:text-xl-semibold text-center text-neutral-950',
        className
      )}
      {...props}
    />
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn(
        'md:text-md-regular text-sm-regular text-center text-neutral-500',
        className
      )}
      {...props}
    />
